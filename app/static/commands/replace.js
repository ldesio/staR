/*GC 2021-01-07 
It is identical to 'generate', what this command needs is a conditional statement in JavaScript that checks 
whether or not the 'input.newvar' does exist in the original dataset. If the var to be replaced DOES NOT EXIST, 
